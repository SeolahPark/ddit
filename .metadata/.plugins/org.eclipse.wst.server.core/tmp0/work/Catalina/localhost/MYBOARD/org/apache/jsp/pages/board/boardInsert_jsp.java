 ...
 * Generated at: 2022-12-29 16:22:48 UTC
...
public final class boardInsert_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t\t<h1>Text Editors<small>Advanced form element</small></h1>\r\n");
      ...
      out.print(request.getContextPath() );
      out.write("/board/Insert.do\" method=\"post\" enctype=\"multipart/form-data\">\r\n");
      out.write("\t\t\t\t\t\t<div class=\"box box-info\">\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"box-header\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"box-title\">CK Editor<small>Advanced and full of features</small></h3>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- tools box -->\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"pull-right box-tools\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"submit\" class=\"btn btn-info btn-sm\" title=\"Collapse\"><i class=\"fa fa-minus\"></i>등록</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" class=\"btn btn-info btn-sm\" title=\"Remove\"><i class=\"fa fa-times\"></i>취소</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t<!-- /. tools -->\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t<!-- /.box-header -->\r\n");
      out.write("\t\t\t\t\t\t\t<div class=\"box-body pad\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"mem_no\" name=\"mem_no\" value=\"60\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<input type=\"hidden\" id=\"file_category\" name=\"file_category\" value=\"1\"/>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t                  <label>Text</label>\r\n");
      out.write("\t\t\t\t\t                  <input type=\"text\" id=\"board_title\" name=\"board_title\" class=\"form-control\" placeholder=\"제목\">\r\n");
      out.write("\t\t\t\t\t                </div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<textarea id=\"board_content\" name=\"board_content\" rows=\"10\" cols=\"80\">This is my textarea to be replaced with CKEditor</textarea>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<!-- 파일업로드를 하면 자꾸 파일이름이 null로 들어간다 -->\r\n");
      out.write("                        \t\t\t<input type=\"file\" id=\"files\" name=\"files\" >\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t</form>\r\n");
      out.write("\t\t\t\t\t<!-- /.box -->\r\n");
      ...
      out.write("\t<script src=\"");
      out.print(request.getContextPath() );
      out.write("/bower_components/ckeditor/ckeditor.js\"></script>\r\n");
      out.write("\t<!-- Bootstrap WYSIHTML5 -->\r\n");
      out.write("\t<script src=\"");
      out.print(request.getContextPath() );
      out.write("/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js\"></script>\r\n");
