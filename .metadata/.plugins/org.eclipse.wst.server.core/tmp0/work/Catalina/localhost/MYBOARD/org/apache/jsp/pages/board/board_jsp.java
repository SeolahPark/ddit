 ...
 * Generated at: 2022-12-29 15:35:34 UTC
...
List<BoardVO> list;
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("\t\t//검색을 해서 2페이지로 넘어갈 때 파라미터를 같이 가져가야하는데 안가져감. 그래서 다시 목록으로 간다.\r\n");
      out.write("\t\tcurrentpage = parseInt($(this).text().trim());\r\n");
      out.write("\t\tstype = ");
      out.print(request.getParameter("stype"));
      out.write("\r\n");
      out.write("\t\tsword = ");
      out.print(request.getParameter("sword"));
      out.write("\r\n");
      out.write("\t\tif(stype!=null && sword!=null){\r\n");
      out.write("\t\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/List.do?page=\"+currentpage+\"&sword=\"+sword+\"&stype=\"+stype; \r\n");
      out.write("\t\t}else{\r\n");
      out.write("\t\t\tlocation.href = \"");
      out.print(request.getContextPath());
      out.write("/board/List.do?page=\"+currentpage; \r\n");
      ...
      out.write("\t\tboardNo = $(this).find(\"td\").eq(0).text();\r\n");
      out.write("\t\tlocation.href = \"");
      out.print(request.getContextPath());
      ...
      out.write("\t\t\t\t\t\t\t\t<select id=\"stype\" class=\"form-control stype\" style=\"width: 15%; margin-right: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"BOARD_TITLE\">제목</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<option value=\"BOARD_CONTENT\">내용</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t</select> \r\n");
      out.write("\t\t\t\t\t\t\t\t<input type=\"text\" id=\"sword\" name=\"table_search\" class=\"form-control float-right\" placeholder=\"Search\" style=\"width: 65%; margin-right: 5px;\">\r\n");
      out.write("\t\t\t\t\t\t\t\t<div class=\"input-group-append\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<button type=\"button\" id=\"searchMy\" class=\"btn btn-default\"><i class=\"fas fa-search\"></i>검색</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<li class=\"page-item\"><a id=\"insert\" class=\"page-link\" href=\"#\">글등록</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
      out.write("\t\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t");
								...
								if(startpage  > 1){
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li class=\"page-item\"><a class=\"page-link prev\" href=\"#\">Previous</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t\t");
} 
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t    \r\n");
...
for(int i = startpage; i<= endpage; i++){
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<li class=\"page-item\"><a class=\"page-link next\" href=\"#\">Next</a></li>\r\n");
      out.write("\t\t\t\t\t\t\t     ");
}
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t</ul>\r\n");
