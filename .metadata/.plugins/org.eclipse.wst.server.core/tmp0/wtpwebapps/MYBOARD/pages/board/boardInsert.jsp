...
<div class="wrapper">
	...
	<div class="content-wrapper">
		...
		<section class="content">
			<div class="row">
				<div class="col-md-12">
					<form action="<%=request.getContextPath() %>/board/Insert.do" method="post" enctype="multipart/form-data">
						<div class="box box-info">
							...
							<div class="box-body pad">
									<input type="hidden" id="mem_no" name="mem_no" value="60"/>
									<input type="hidden" id="file_category" name="file_category" value="1"/>
